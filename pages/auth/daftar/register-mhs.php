<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (empty($username) || empty($password) || empty($nama) || empty($nim) || empty($prodi) || empty($email) || empty($hp) || empty($tahun_masuk)) {
            ...
            if ($db->conn->query($sql)) {
                ...
                $sql_mhs = "INSERT INTO t_responden_mahasiswa (user_id, responden_nim, responden_nama, responden_prodi, responden_email, responden_hp, tahun_masuk, responden_tanggal) 
                VALUES ('$user_id', '$nim', '$nama', '$prodi', '$email', '$hp', '$tahun_masuk', NOW())";
                
                if ($db->conn->query($sql_mhs)) {
        ...
        <div class="card w-50 d-block mx-auto">
            <div class="card-body p-5">
                <div class="d-flex flex-column gap-5">
                    ...
                    <form action="?page=register-mhs" method="POST">
                        <div class="d-flex flex-column gap-3">
                            ...
                            <div class="form-group">
                                <label class="form-label">Tahun Masuk</label></label>
