<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (empty($username) || empty($password) || empty($nama) || empty($nopeg) || empty($unit)) {
            ...
            if ($db->conn->query($sql)) {
                ...
                $sql_tendik = "INSERT INTO t_responden_tendik (user_id, responden_nopeg, responden_nama, responden_unit, responden_tanggal) 
                VALUES ('$user_id', '$nopeg', '$nama', '$unit', NOW())";
                
                if ($db->conn->query($sql_tendik)) {
    ...
    <div class="container-fluid py-4">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Tendik</li>
            </ol>
        </nav>
    </div>
</section>
        ...
        <div class="card w-50 d-block mx-auto">
            <div class="card-body p-5">
                <div class="d-flex flex-column gap-5">
                    ...
                    <form action="?page=register-tendik" method="POST">
                        <div class="d-flex flex-column gap-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nopeg" class="form-control" placeholder="Contoh: 123456765">
                            </div>
                            <div class="form-group">
