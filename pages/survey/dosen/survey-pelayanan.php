<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $user_info= $crud->takeDataDosen($username);
        $responden_dosen_id = $user_info['responden_id']; 
        ...
        foreach ($soalList as $soal) {  
            ...
            $crud -> inputJawabanDosen($responden_dosen_id , $soal_id , $jawaban);
        }
    ...
    <div class="container-fluid py-4">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="?page=dosen/isi-survey">Isi Survey</a>
                </li>
