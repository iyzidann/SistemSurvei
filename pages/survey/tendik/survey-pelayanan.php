<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $user_info= $crud->takeDataTendik($username);
        $responden_tendik_id = $user_info['responden_id']; 
        ...
        foreach ($soalList as $soal) {  
            ...
            $crud -> inputJawabanTendik($responden_tendik_id , $soal_id , $jawaban);
        }
    ...
    <div class="container-fluid py-4">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="?page=tendik/isi-survey">Isi Survey</a>
                </li>
