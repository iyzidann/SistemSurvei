<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $user_info= $crud->takeDataAlumni($username);
        $responden_alumni_id = $user_info['responden_id']; 
    ...
    <div class="container-fluid py-4">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="?page=alumni/isi-survey">Isi Survey</a>
                </li>
                    ...
                    <div class="d-block mx-auto" style="width: 100vh;">
                        <div class="d-flex flex-column gap-4">
                            ...
                            <div class="d-flex justify-content-end">
                                <a href="?page=pesan-berhasil" class="btn btn-sm btn-primary">Submit</a>
                            </div>
                        </div>
                    </div>
                </form>
