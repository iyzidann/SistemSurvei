<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $user_info= $crud->takeDataMahasiswa($username);
        $responden_mahasiswa_id = $user_info['responden_id']; 
        ...
        foreach ($soalList as $soal) {  
            ...
            $crud -> inputJawabanMahasiswa($responden_mahasiswa_id , $soal_id , $jawaban);
        }
...
<section class="bg-primary-2">
    <div class="container-fluid py-4">
        <h1 class="text-heading-xl font-lato fw-bolder">SURVEI KUALITAS PENDIDIKAN</h1>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="?page=mahasiswa/isi-survey">Isi Survey</a>
                </li>
                <li class="breadcrumb-item active" aria-current="page">Survei Kualitas Pendidikan</li>
            </ol>
        </nav>
    </div>
</section>
        ...
        <div class="card-body p-5">
            <div class="d-flex flex-column gap-5">
                <div class="d-flex flex-column align-items-center gap-2">
                    <h1 class="text-heading-xl font-poppins my-0">Kuesioner Kualitas Pendidikan</h1>
                    <p class="text-body-md font-poppins my-0">Isi survey dengan kondisi sebenarnya pada Politeknik Negeri Malang.</p>
                </div>
                <form action="?page=mahasiswa/survey-kualitas-pendidikan" method="POST">
