...
<section class="bg-primary-2">
    <div class="container-fluid py-4">
        <h1 class="text-heading-xl font-lato fw-bolder">SURVEI PELAYANAN</h1>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Survei Pelayanan</li>
            </ol>
        </nav>
    </div>
</section>
        ...
        <div class="card-body p-5">
            <div class="d-flex flex-column gap-5">
                <div class="d-flex flex-column align-items-center gap-2">
                    <h1 class="text-heading-xl font-poppins my-0">Kuesioner Pelayanan</h1>
                    <p class="text-body-md font-poppins my-0">Isi survey dengan kondisi sebenarnya pada Politeknik Negeri Malang.</p>
                </div>
                <form action="?page=mahasiswa/survey-pelayanan" method="POST">
