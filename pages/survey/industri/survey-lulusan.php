...
<section class="bg-primary-2">
    <div class="container-fluid py-4">
        <h1 class="text-heading-xl font-lato fw-bolder">SURVEI LULUSAN</h1>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Survei Lulusan</li>
            </ol>
        </nav>
    </div>
</section>
        ...
        <div class="card-body p-5">
            <div class="d-flex flex-column gap-5">
                <div class="d-flex flex-column align-items-center gap-2">
                    <h1 class="text-heading-xl font-poppins my-0">Kuesioner Lulusan</h1>
